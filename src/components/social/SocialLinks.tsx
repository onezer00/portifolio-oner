...
const links = [
  {
    href: 'https://github.com/onezer00',
    label: 'GitHub',
    icon: (
  ...
  {
    href: 'https://www.linkedin.com/in/onerzer00/',
    label: 'LinkedIn',
    icon: (
  ...
  <div className="flex gap-4 mt-4 justify-center">
    {links.map((link) => (
      <a
        ...
        className="text-zinc-700 dark:text-zinc-200 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors transform hover:scale-110"
